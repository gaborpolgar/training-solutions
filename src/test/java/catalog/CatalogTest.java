...
public class CatalogTest {
    ...
    public void testFindByCriteriaBoth() {
        ...
        catalog.addItem(catalogItem1);
        catalog.addItem(catalogItem2);
        System.out.println(catalog.findByCriteria(searchCriteria).toString());
...
//szerintem itt kettőt várunk el, mert megtalálja a title-t is és megtalálja Dan Rynolds-ot is a catalogItem1-ben
    }
