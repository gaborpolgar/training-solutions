...
public class NumberStatistics {
    ...
    NumberStatistics numbstat = new NumberStatistics(Arrays.asList(4, 8, -1, 4, 5, 3));
        System.out.println(numbstat.sumPositives());
        NumberStatistics task2 = new NumberStatistics(Arrays.asList(4, 8, -1, -2, 4, 5, 3));
        System.out.println(task2.minDifferenceBetweenNeighbours());
    }
